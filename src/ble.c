...
static int32_t initial_voltage = 0;
static int32_t voltage_20s = 0;
...
static void clear_bonds(const struct bt_bond_info *info, void *user_data) {
    // Unpair each device found in the bond list
